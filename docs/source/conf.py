# -*- coding: utf-8 -*-
#
# fuzzycomp documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath( '../../fuzzycomp/' ) )
...
project = u'fuzzycomp'
copyright = u'2011, Bjoern Larsson'
...
htmlhelp_basename = 'fuzzycompdoc'
